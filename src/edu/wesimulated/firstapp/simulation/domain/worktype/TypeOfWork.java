...
/**
 * Algo curioso sobre el diseño de los simuladores es que hay cosas que van a ser aprendidas por el sistema
 * por los datos ingresados durante el uso
 * pero va a haber otras cosas que van a ser fijadas por mi diseño
 * Lo ideal sería que lo que yo establezca sea lo menor posible para que el simulador pueda adaptarse 
 * a cualquier tipo de proyecto
 * Algo que estoy fijando por código es los distintos tipos de trabajo
 * y que consecuencias tienen en las entidades participantes de la simulación
 * Si bien los números exactos son calculados con IA
 */
